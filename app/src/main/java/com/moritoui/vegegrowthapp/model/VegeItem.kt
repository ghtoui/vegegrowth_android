...
data class VegeItemData(val datas: List<VegeItem>, val page: Int)

@Serializable
data class VegeItem(val id: Int = 0, val name: String, val category: VegeCategory, val uuid: String = "", var status: VegeStatus, val folderId: Int?)
